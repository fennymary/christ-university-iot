...
import { LightbulbIcon, ChevronRight, Users, BookOpen, ArrowRight, Lightbulb } from "lucide-react"
import { Button } from "@/components/ui/button"
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-200 shadow-inner">
      ...
      {isMenuOpen && (
        <div className="md:hidden fixed inset-0 bg-white z-50 p-6 flex flex-col">
          <div className="flex justify-between items-center mb-8">
            ...
            <Button variant="ghost" size="icon" className="text-[#0f1e45]" onClick={() => setIsMenuOpen(false)}>
              <ChevronRight size={24} />
            </Button>
          </div>

          <div className="space-y-6 text-lg font-medium text-[#0f1e45]">
            <a href="home" className="block py-2 border-b border-gray-100">
              Home
            </a>
            <a href="about" className="block py-2 border-b border-gray-100">
              About
            </a>
            <a href="faculty" className="block py-2 border-b border-gray-100">
              Faculty
            </a>
            <a href="collabration" className="block py-2 border-b border-gray-100">
              Collaboration
            </a>
            <a href="consultation" className="block py-2 border-b border-gray-100">
              Consultation
            </a>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="bg-slate-100 rounded-3xl shadow-2xl p-8">
            ...
            <p className="text-slate-700 leading-relaxed mt-4">
              ...
              initiative will establish a collaborative ecosystem where academic research translates into practical,
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="font-medium text-navy-900">Healthcare Management</h4>
                    <p className="text-slate-600 text-sm mt-1">
                      ARIIOT leverages AI, machine learning, and blockchain for smart healthcare, focusing on predictive
                      analytics, telemedicine, and cybersecurity.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="font-medium text-navy-900">Video Analytics</h4>
                    <p className="text-slate-600 text-sm mt-1">
                      ARIIOT researches AI-driven video analytics for surveillance, traffic management, and behavior
                      analysis, offering consultancy in smart city security, retail, and automated quality inspection.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="font-medium text-navy-900">Cold Chain Management</h4>
                    <p className="text-slate-600 text-sm mt-1">
                      ARIIOT explores AI, IoT, and blockchain for cold chain monitoring, offering consultancy in smart
                      storage, AI-driven logistics, and energy-efficient supply chain solutions.
                    </p>
                  </div>
                </li>
              </ul>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="font-medium text-navy-900"> Video Analytics - IRetail </h4>
                    <p className="text-slate-600 text-sm mt-1">
                      Developing an Integrated Video Analytics Solution for optimizing retail layouts, enhancing
                      customer engagement, and enabling data-driven merchandising decisions.
                    </p>
                  </div>
                </li>
                <li className="flex items-start mt-6">
                  ...
                  <div className="ml-4">
                    <h4 className="font-medium text-navy-900">Medical Imaging (Automation) - iHealthcare</h4>
                    <p className="text-slate-600 text-sm mt-1">
                      Developing AI-powered adaptive exposure control, cloud-based processing, and data masking for
                      high-quality, privacy-compliant medical imaging.
                    </p>
                  </div>
                </li>
                <li className="flex items-start mt-6">
                  ...
                  <div className="ml-4">
                    <h4 className="font-medium text-navy-900">IoT Edge Connectivity Solutions for Smart Buildings</h4>
                    <p className="text-slate-600 text-sm mt-1">
                      Developing a modular, secure, and low-latency IoT framework with seamless device integration and a
                      real-time WISE-PaaS dashboard for smart building management.
                    </p>
                  </div>
                </li>
                <li className="flex items-start mt-6">
                  ...
                  <div className="ml-4">
                    <h4 className="font-medium text-navy-900"> Cold Chain Management System for Vaccine Storage</h4>
                    <p className="text-slate-600 text-sm mt-1">
                      Developing an IoT-driven cold chain system with real-time monitoring, predictive analytics, smart
                      packaging, and energy-efficient transportation to enhance sustainability and efficiency.
                    </p>
                  </div>
                </li>
              </ul>
      ...
      <section className="py-12 px-6 md:px-12 bg-slate-50">
        <div className="container mx-auto">
          <h2 className="text-2xl font-bold text-navy-900 mb-8">Advisory Board</h2>

          {/* Senior Faculty from CHRIST University */}
          <div className="bg-white rounded-3xl shadow-sm p-8 mb-8">
            <div className="flex items-center mb-6">
              <div className="bg-slate-100 p-3 rounded-full">
                <Users className="h-6 w-6 text-navy-900" />
              </div>
              <h3 className="text-xl font-bold text-navy-900 ml-4">Senior Faculty from CHRIST University</h3>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-200">
                    <th className="text-left py-3 px-4 text-slate-600 font-bold w-[80px]">S.N</th>
                    <th className="text-left py-3 px-4 text-slate-600 font-bold">Name</th>
                    <th className="text-left py-3 px-4 text-slate-600 font-bold">Affiliation</th>
                    <th className="text-left py-3 px-4 text-slate-600 font-bold">Contact and Mail ID</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-slate-100">
                    <td className="py-3 px-4 text-slate-800">1</td>
                    <td className="py-3 px-4 text-slate-800">Dr Balamurugan M</td>
                    <td className="py-3 px-4 text-slate-800">
                      HOD, Dept. of CSE, SoET, CHRIST (Deemed to be University), Bangalore
                    </td>
                    <td className="py-3 px-4 text-slate-800">
                      +91 9047430101
                      <br />
                  ...
                  <tr>
                    ...
                    <td className="py-3 px-4 text-slate-800">
                      +91 8105678191
                      <br />
                      vandana.reddy@christuniversity.in
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          {/* Representative(s) from Advantech India */}
          <div className="bg-white rounded-3xl shadow-sm p-8 mb-8">
            <div className="flex items-center mb-6">
              <div className="bg-slate-100 p-3 rounded-full">
                <Users className="h-6 w-6 text-navy-900" />
              </div>
              <h3 className="text-xl font-bold text-navy-900 ml-4">Representative(s) from Advantech India</h3>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-slate-100">
                    <td className="py-3 px-4 text-slate-800">1</td>
                    <td className="py-3 px-4 text-slate-800">Amy Wu</td>
                    <td className="py-3 px-4 text-slate-800">AIoT Developer InnoWorks, Advantech, Taiwan</td>
                    <td className="py-3 px-4 text-slate-800">
                      +886 2792-7818 #7794
                      <br />
                      amyyj.Wu@advantech.com.tw
                    </td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-800">2</td>
                    <td className="py-3 px-4 text-slate-800">Mark Yang</td>
                    <td className="py-3 px-4 text-slate-800">
                      Associate Vice President of EIoT and AInterCon at Advantech
                    </td>
                    <td className="py-3 px-4 text-slate-800">mark.Yang@advantech.com.tw</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {/* Industry Experts in IoT/Industrial Automation */}
          <div className="bg-white rounded-3xl shadow-sm p-8">
            <div className="flex items-center mb-6">
              <div className="bg-slate-100 p-3 rounded-full">
                <Users className="h-6 w-6 text-navy-900" />
              </div>
              <h3 className="text-xl font-bold text-navy-900 ml-4">Industry Experts in IoT/Industrial Automation</h3>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-200">
                    <th className="text-left py-3 px-4 text-slate-600 font-medium w-[80px]">S.N</th>
                    <th className="text-left py-3 px-4 text-slate-600 font-medium">Name</th>
                    <th className="text-left py-3 px-4 text-slate-600 font-medium">Affiliation</th>
                ...
                <tbody>
                  <tr className="border-b border-slate-100">
                    <td className="py-3 px-4 text-slate-800">1</td>
                    <td className="py-3 px-4 text-slate-800">Lakshmi Narasimhan</td>
                    <td className="py-3 px-4 text-slate-800">Partner Business Development Manager, CISCO</td>
                    <td className="py-3 px-4 text-slate-800"></td>
                  </tr>
                  <tr className="border-b border-slate-100">
                    <td className="py-3 px-4 text-slate-800">2</td>
                    <td className="py-3 px-4 text-slate-800">Mallesh</td>
                    <td className="py-3 px-4 text-slate-800">Founder and CEO at cultYvate</td>
                    <td className="py-3 px-4 text-slate-800"></td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-800">3</td>
                    <td className="py-3 px-4 text-slate-800">Arjun</td>
                    <td className="py-3 px-4 text-slate-800">Souk</td>
                    <td className="py-3 px-4 text-slate-800"></td>
                  </tr>
                </tbody>
              </table>
