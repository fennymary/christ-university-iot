  ...
  const facultyMembers: Faculty[] = [
    {
      ...
      publications: [
        ...
        "Sambandam, R. K., & John, S. P. (2024). A comprehensive review of small building detection in collapsed images: Advancements and applications of machine learning algorithms. Lecture Notes in Networks and Systems.",
        ...
        "Sathiyapriya, K., Thaiyalnayaki, S., Sambandam, R. K., Anuranjani, K., & Vetriveeran, D. (2022). Smart precision irrigation techniques using wireless underground sensors in wireless sensors. 2022 8th International Conference on Advanced Computing and Communication Systems (ICACCS), 2072–2077.",
    ...
    // Moving Dr. Venkataswamy R (the last faculty) to the middle position
    {
      ...
      publications: [
        "Venkataswamy, R., Janamala, V., & Chowdary, C. R. (2023). Realization of humanoid doctor and real-time diagnostics of disease using Internet of Things, Edge Impulse platform, and ChatGPT. Annals of Biomedical Engineering.",
        "Venkataswamy, R., Rao, K. U., & Meena, P. (2023). Transformer performance enhancement by optimized charging strategy for electric vehicles. Archives of Electrical Engineering.",
